...
let usedMobilesCompanies = ['City Cell', 'Nokia', 'Kingstar', 'Java Mobile', 'Micromax', 'Okapia', 'Xiaomi', 'Infinix', 'OnePlus'];

let i = 0;
while (i < usedMobilesCompanies.length) {
    console.log(usedMobilesCompanies[i]);
    i++;
}